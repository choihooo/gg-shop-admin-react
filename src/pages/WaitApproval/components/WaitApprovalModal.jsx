...
import styles from "./WaitApprovalModal.module.css";

function WaitApprovalModal({ onClose, item }) {
  return (
        ...
        <table className={styles.detailTable}>
          <tbody>
            ...
            <tr>
              ...
              <th>사업자 번호</th>
              <td>{item.businessType === "사업자" ? "사업자 번호" : "-"}</td>
            </tr>
            <tr>
              <th>주민등록번호</th>
              <td>000</td>
...
export default WaitApprovalModal;
